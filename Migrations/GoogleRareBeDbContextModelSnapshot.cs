...
namespace GoogleRareBe.Migrations
{
    ...
    partial class GoogleRareBeDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 953, DateTimeKind.Local).AddTicks(2267),
                            Post_id = 1
                        },
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(765),
                            Post_id = 2
                        },
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(784),
                            Post_id = 3
                        });
                });
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(5046),
                            RareUserId = 1,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(5880),
                            RareUserId = 2,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(5889),
                            RareUserId = 3,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(5891),
                            RareUserId = 4,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 21, 44, 955, DateTimeKind.Local).AddTicks(5893),
                            RareUserId = 5,
            ...
            modelBuilder.Entity("GoogleRareBe.Models.PostTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author_id = 1,
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5187),
                            Ended_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5417),
                            Follower_id = 1
                        },
                        new
                        {
                            Id = 2,
                            Author_id = 2,
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5642),
                            Ended_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5648),
                            Follower_id = 2
                        },
                        new
                        {
                            Id = 3,
                            Author_id = 3,
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5650),
                            Ended_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5651),
                            Follower_id = 3
                        },
                        new
                        {
                            Id = 4,
                            Author_id = 4,
                            Created_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5652),
                            Ended_on = new DateTime(2024, 3, 16, 11, 21, 44, 956, DateTimeKind.Local).AddTicks(5654),
                            Follower_id = 4
                        });
                });
