...
namespace GoogleRareBe.Migrations
{
    ...
    [Migration("20240316161521_InitialCreate")]
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 889, DateTimeKind.Local).AddTicks(2511),
                            Post_id = 1
                        },
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 891, DateTimeKind.Local).AddTicks(3805),
                            Post_id = 2
                        },
                        new
                        {
                            ...
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 891, DateTimeKind.Local).AddTicks(3857),
                            Post_id = 3
                        });
                });
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 15, 20, 892, DateTimeKind.Local).AddTicks(934),
                            RareUserId = 1,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 15, 20, 892, DateTimeKind.Local).AddTicks(2216),
                            RareUserId = 2,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 15, 20, 892, DateTimeKind.Local).AddTicks(2233),
                            RareUserId = 3,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 15, 20, 892, DateTimeKind.Local).AddTicks(2236),
                            RareUserId = 4,
                        ...
                        new
                        {
                            ...
                            PublicationDate = new DateTime(2024, 3, 16, 11, 15, 20, 892, DateTimeKind.Local).AddTicks(2239),
                            RareUserId = 5,
            ...
            modelBuilder.Entity("GoogleRareBe.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author_id = 1,
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(8834),
                            Ended_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9207),
                            Follower_id = 1
                        },
                        new
                        {
                            Id = 2,
                            Author_id = 2,
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9523),
                            Ended_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9533),
                            Follower_id = 2
                        },
                        new
                        {
                            Id = 3,
                            Author_id = 3,
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9537),
                            Ended_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9539),
                            Follower_id = 3
                        },
                        new
                        {
                            Id = 4,
                            Author_id = 4,
                            Created_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9541),
                            Ended_on = new DateTime(2024, 3, 16, 11, 15, 20, 894, DateTimeKind.Local).AddTicks(9543),
                            Follower_id = 4
                        });
                });
